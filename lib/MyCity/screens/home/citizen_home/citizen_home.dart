  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNav(
        // onEmergencyTap: () {
        //   // Navigate to Emergency screen when Emergency icon is tapped
        //   Get.toNamed(AppRoutes.ULB_SERVICE_MANAGEMENT);
        // },
        onGridTap: () {
          // Navigate to Grid screen when Grid icon is tapped
          Get.toNamed(AppRoutes.CITIZEN_MENU); //  navigate to citizen menu screen
        },
        // onHomeTap: () {
        ...
        // },
        // onCustomTap: (index) {
        //   // Handle the dynamic navigation based on the selected index
        //   switch (index) {
        //     case 0: // Emergency
        //       Get.toNamed(AppRoutes.ULB_SERVICE_MANAGEMENT);
        //       break;
        ...
        //       Get.toNamed(AppRoutes.ULB_SERVICE_MANAGEMENT);
        //       break;
        //     default: // Default fallback (Grid or others)
        //       Get.toNamed(AppRoutes.ULB_SERVICE_MANAGEMENT);
        //   }
        // },
      ),
