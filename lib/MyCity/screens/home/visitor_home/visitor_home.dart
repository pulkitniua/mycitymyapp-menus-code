...
class _VisitorHomeScreenState extends State<VisitorHomeScreen> {
  ...
  final List<TextModel> visitorsCards = [
    ...
    TextModel(title: 'Kumbh', icon: 'assets/v2_images/kumbh.svg'),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar:  BottomNav(
         onGridTap: () {
          // Navigate to Grid screen when Grid icon is tapped
          Get.toNamed(AppRoutes.VISITOR_MENU); //  navigate to citizen menu screen
        },
      ),
    );
  }
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (service.title == 'Kumbh') {
                            const url = 'https://kumbh.gov.in/';
                            ...
                            const url =
                                "http://15.207.2.81/upyogdesign/vistor.html";
                        ...
                        child:
                            ...
                            //     :
                            service.icon != null
                                ? service.icon?.split('.').lastOrNull == 'svg'
                                    ? SvgPicture.asset(
                                        service.icon!,
                                        height: 40.h,
                                        width: 40.w,
