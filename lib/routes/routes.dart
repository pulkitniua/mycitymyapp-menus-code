...
import 'package:mobile_app/screens/citizen/login/login_screen.dart';
...
import 'package:mobile_app/screens/employee/emp_uc_collect/emp_uc_collect.dart';
...
class AppRoutes {
  ...
  static const String CITIZEN_MENU = '/CITIZEN_MENU';
  static const String VISITOR_MENU = '/VISITOR_MENU';
  static const String BUSINESS_MENU = '/BUSINESS_MENU';
  /* -------------------------------------------------------------------------- */
  /*                               Employee Routes                              */
  /* -------------------------------------------------------------------------- */
  ...
  static const String EMP_UC_COLLECT = '/EMP_UC_COLLECT';
  ...
  static List<GetPage> getPages = [
    ...
    GetPage(name: CITIZEN_MENU, page: () => const CitizenMenu()),
    GetPage(name: VISITOR_MENU, page: () => const VisitorMenu()),
    GetPage(name: BUSINESS_MENU, page: () => const BusinessMenu()),
    /* -------------------------------------------------------------------------- */
    /*                               EMPLOYEE ROUTES                              */
    /* -------------------------------------------------------------------------- */
