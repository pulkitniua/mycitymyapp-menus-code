...
import 'package:mobile_app/widgets/banner_news/latest_news_widget.dart';
...
class _HomeScreenState extends State<HomeScreen> {
                  ...
                  child: authController.isLoading.value
                      ...
                      : Column(
                          ...
                          children: [
                            ...
                            LatestNewsWidget(
                              orientation: o,
                              bannerImages: BaseConfig.APP_LOGIN_BANNERS_V2,
  ...
  //   //BaseConfig.APP_HOME_BANNERS
  //   const bannerImages = BaseConfig.APP_LOGIN_BANNERS_V2;
  //   return SizedBox(
  //     height: o == Orientation.portrait ? 280.h : 220.h,
  //     child: PageView.builder(
  //       controller: _pageController,
  //       itemCount: bannerImages.split(',').length,
  ...
  //         final img = bannerImages.split(',')[index];
  //         return FractionallySizedBox(
  //           widthFactor: 1 / _pageController.viewportFraction,
  //           child: NewsCard(
  //             img: img,
  //             orientation: o,
  //             length: bannerImages.split(',').length,
  //             pageController: _pageController,
  //           ),
  //         );
  //       },
